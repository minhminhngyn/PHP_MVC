...
// Tạo màu
$background_color = imagecolorallocate($captcha_image, 255, 255, 255); // Trắng
$text_color = imagecolorallocate($captcha_image, 0, 0, 0); // Đen
...
// Xuất hình ảnh
header('Content-Type: image/png'); // Đảm bảo header được gửi trước khi xuất hình
